...
public interface AntInterfaceIntent {
	...
	public static final String ANT_ENABLING_ACTION   = "com.dsi.ant.intent.action.ANT_ENABLING";
	public static final String ANT_ENABLED_ACTION    = "com.dsi.ant.intent.action.ANT_ENABLED";
	public static final String ANT_DISABLING_ACTION  = "com.dsi.ant.intent.action.ANT_DISABLING";
